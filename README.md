...
In this case study, I'm building a Stocks Portfolio using stocks only from Germany to simplify the process of applying Markowitz Theory since we have to consider the Market Portfolio which is regarded as the German stock index (DAX), and also, if I build a portfolio with stocks that trade in different currencies, I have to consider about the exchange rate and the method to determine the exchange rate.
